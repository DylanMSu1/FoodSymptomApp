...
import com.example.foodapp.databinding.FragmentSymptomsBinding
...
class SymptomsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textView: TextView = binding.textSymptoms
        symptomsViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
